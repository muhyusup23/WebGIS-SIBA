...
L.Control.ZoomBar = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._zoomInButton = this._createButton("+", "Zoom In", "leaflet-control-zoom-in", container, this._zoomIn, this);

    this._zoomStartButton = this._createButton("", "Zoom ke posisi awal", "leaflet-control-zoom-to-start", container, this._zoomStart, this);

    this._zoomOutButton = this._createButton("-", "Zoom Out", "leaflet-control-zoom-out", container, this._zoomOut, this);
